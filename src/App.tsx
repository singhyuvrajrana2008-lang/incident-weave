...
function NotFound() {
  return (
    <div className="grid min-h-screen place-items-center px-6 text-center">
      <div>
        <Logo />
        <h1 className="mt-6 font-display text-5xl font-extrabold text-fg">404</h1>
        <p className="mt-2 text-fg-dim">This page couldn't be found.</p>
        <Link to="/" className="mt-6 inline-block"><Button variant="primary">Back to home</Button></Link>
      </div>
    </div>
  );
}
