  ...
  return (
    <Page>
      ...
      {error && (
        <p
          role="alert"
          className="mb-4 rounded-md border border-crimson/30 bg-crimson/10 p-3 text-sm text-crimson"
        >
          {error}
        </p>
      )}
                ...
                {rows.map((inv) => (
                  ...
                  >
                    <td className="px-4 py-3">
                      ...
                      <div className="max-w-xs truncate text-xs text-fg-dim">
                        {inv.description}
                      </div>
                    </td>
                    ...
                    <td className="px-4 py-3 text-right font-mono tabular">
                      <span className="text-amber">{inv.unknownCount}</span>
                    </td>
                    <td className="px-4 py-3">
